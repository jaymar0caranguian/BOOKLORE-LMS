...
$sql_check = "SELECT COUNT(*) AS cnt FROM books WHERE author_id = $id";
...
if ($count > 0) {
    ...
    echo "Cannot delete this author because there are books associated with it.";
} else {
    // No dependent records, so delete the author
    $sql_delete = "DELETE FROM author WHERE id = $id";
